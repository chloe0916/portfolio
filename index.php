	...
	<body class="homepage is-preload">
		<div id="page-wrapper">
				...
				<div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							...
							<footer>
								<a href="#banner" class="button circled scrolly">Knock</a>
							</footer>
						</div>
			...
			<p><p></p>
				<div class="wrapper style2">
					...
					<article id="main" class="container special">
						...
						<header>
							<h2><a>Draw ourselves in Peanuts Character</a></h2>
							<p>
			...
			<!-- Features -->
				...
				<article class="col-4 col-12-mobile special">
					<a href="#" class="image featured"><img src="images/pic08.jpeg" style="max-width: 100%; height: 280px" ;alt="" /></a>
							...
							<div class="col-12">
								...
								<!-- Contact -->
									<section class="contact">
										<header>
											<h3>2021 &copy; You can send me an <a href="mailto: jinjoo_jung@apple.com" title="E-mail">E-mail</h3>
